...
**IT Professional | Cybersecurity & Systems Security Operations Engineer**

Results-driven IT professional bridging enterprise technology operations with deep infrastructure hardening, defense-in-depth engineering, and Agile methodology frameworks. Experienced in deploying enterprise Linux sandboxes, scripting process automation engines, building high-entropy cryptographic environments, and implementing strict IT Asset Management (ITAM) lifecycles.

---

### Core Technical Arsenal & Competencies

| Functional Domain | Technologies, Frameworks & Core Focus States |
| :--- | :--- |
| **Operating Systems** | Red Hat Enterprise Linux (RHEL) 10, CentOS 7, Ubuntu Workstation, Windows 11 Enterprise, WSL2 |
| **Infrastructure & Networking** | Cisco Routing/Switching, UEFI/NVRAM Boot Topologies, IP Addressing, VPN Implementations |
| **Security & Auditing** | LUKS Device Encryption, VeraCrypt Volumes, Log Analysis (Syslog, Auth.log), System Hardening |
| **Automation & Data** | Python (Process Automation & Curses Engine), Database Foundations (SQL models), Bash, Lua |
| **Operations & Quality** | IT Asset Management (ITAM), Six Sigma Foundations, Lean Tools (Define & Measure), Agile Teams |
...
* **B.S. Cybersecurity** | Southern New Hampshire University *(Active Coursework)*
* **CCNA Engineering Track** | Complete Enterprise Architecture Routing Protocols *(In Progress)*
